...
typedef union {
    ...
    bool get_ANF1() { return raw >> 7 & 0x1; }
    ...
    bool get_CREEP_AUS() { return raw >> 6 & 0x1; }
    ...
    uint8_t get_SLV_MS() { return raw >> 1 & 0xf; }
    ...
    bool get_KOMP_NOTAUS() { return raw >> 0 & 0x1; }
    ...
    uint8_t get_GMIN_MS() { return raw >> 13 & 0x7; }
    ...
    uint8_t get_GMAX_MS() { return raw >> 10 & 0x7; }
    ...
    bool get_ZH_AUS_MS() { return raw >> 9 & 0x1; }
    ...
    bool get_CRASH_MS() { return raw >> 31 & 0x1; }
    ...
    bool get_KOMP_BAUS() { return raw >> 30 & 0x1; }
    ...
    bool get_MSS_AKT() { return raw >> 29 & 0x1; }
    ...
    bool get_MSS_KL() { return raw >> 28 & 0x1; }
    ...
    bool get_V_DSPL_NEU() { return raw >> 24 & 0x1; }
    ...
    bool get_V_MAX_SUM() { return raw >> 39 & 0x1; }
    ...
    bool get_NOTL() { return raw >> 38 & 0x1; }
    ...
    bool get_KD_MS() { return raw >> 37 & 0x1; }
    ...
    bool get_V_MAX_EIN() { return raw >> 36 & 0x1; }
    ...
    bool get_TM_REG() { return raw >> 35 & 0x1; }
    ...
    bool get_PWG_ERR() { return raw >> 32 & 0x1; }
    ...
    bool get_V_DSPL_ERR() { return raw >> 45 & 0x1; }
    ...
    bool get_V_DSPL_LIM() { return raw >> 44 & 0x1; }
    ...
    bool get_V_MAX_REG() { return raw >> 43 & 0x1; }
    ...
    bool get_TM_EIN() { return raw >> 42 & 0x1; }
    ...
    uint8_t get_FMMOTMAX() { return raw >> 48 & 0xff; }
    ...
    uint8_t get_V_MAX_TM() { return raw >> 56 & 0xff; }
